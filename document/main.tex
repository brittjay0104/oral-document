...
There are a variety of ways that a tool can get the attention of its user~\cite{robillard2014recommendation}. Program analysis tools get the attention of developers in their IDEs in one or more of the following ways: icons, dashboards, pop-ups, affordance overlays, or email notifications.

All program analysis tools provide descriptive interfaces that convey information about a developer's source code once the tool has her attention. 
Information is conveyed using some combination of textual, visual, and sometimes transformative descriptions.

Some tools, like FindBugs, 
% TODO finish here, bring together these lists into some examples of components since already listed rather than listing and explaining each
...
\noindent\textit{Popups.}
% TODO Find tool that alerts developer via pop-up? 

\noindent\textit{Affordance Overlays.} Affordance overlays annotate the user interface by provide visual overlays on top of user interface affordances. For example, after execution EclEmma notifies the developer of code coverage by providing visual overlays on the code (Figure~\ref{fig:ecl}). 
...
All program analysis tools provide descriptive interfaces that convey information about a developer's source code once the tool has her attention~\cite{robillard2014recommendation}. 
Information is conveyed using some combination of textual, visual, and sometimes transformative descriptions.

\noindent\textit{Textual Descriptions.} Textual descriptions provide information using primarily text. Text descriptions are sometimes augmented with visual elements to enhance the ability to communicate the necessary information. For example, tools like FindBugs and PMD use mostly text to communicate information, however, they also use color to represent information importance.

\noindent\textit{Visual Descriptions.}

\noindent\textit{Transformative Descriptions.} 
% TODO WitchDoctor
